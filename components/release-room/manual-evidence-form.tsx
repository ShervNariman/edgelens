      ...
      {open ? (
        ...
        >
          <div className="space-y-1.5">
            ...
            <select
              id={`${titleId}-group`}
              className="flex h-9 w-full rounded-lg border border-[var(--rr-line)] bg-white px-3 text-sm outline-none focus-visible:ring-2 focus-visible:ring-[var(--rr-focus)]"
              value={form.group}
              onChange={(e) =>
                setForm((f) => ({
                  ...f,
