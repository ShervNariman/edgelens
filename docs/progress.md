...
| [SHE-10](https://linear.app/sherv-nariman/issue/SHE-10/edgelens-add-launch-assets-document) | Launch assets | Done | Codex | Merged #4 | `docs/launch.md` exists; SHE-19 narrows framing. | Replace URL placeholders before post. |
| [SHE-9](https://linear.app/sherv-nariman/issue/SHE-9/edgelens-create-launch-ready-readme-and-repo-polish) | README polish | Done | Codex | Merged #8 | Launch-ready README landed; SHE-19 adds prior art. | Spot-check commands/links at announce time. |
...
| Release readiness | Issues SHE-7, SHE-19, plus release checklist / launch capture | Focus review on items that still gate public launch. |
